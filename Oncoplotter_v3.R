...
if (file.exists('Clinical_annotation.txt')){
  ...
  #------------------------------------------------------------------------------#
  options_df <- read_excel("oncoplot_options_v3.xlsx", col_names = TRUE)
  ...
  Oncoprint_color <- c(
    ...
    `5_prime_UTR_variant` = get_option("5'_UTR_variant"),
    `3_prime_UTR_variant` = get_option("3'_UTR_variant"),
  ...
  categorical_colors <- options_df$Value[47:146]
  categorical_groups <- split(categorical_colors, ceiling(seq_along(categorical_colors) / 20))
  ...
  continuous_colors <- options_df$Value[147:156]
  ...
  gene <- subset(maf_lolli, maf_lolli$Variant_Classification!="Intron_variant"
                 ...
                 & maf_lolli$Variant_Classification != "5_prime_UTR_variant"
                 & maf_lolli$Variant_Classification != "3_prime_UTR_variant"
